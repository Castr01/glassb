...
public class BlowItem extends Task {
    ...
    public boolean validate() {
        return UserInterfaceData.itemToBlowIndex != -1 && Inventory.contains("Molten glass") && Inventory.contains("Glassblowing pipe") && System.currentTimeMillis() > Data.lastAnimation + 3500;
    }
    ...
    public int execute() {
        ...
        if(glassPipe != null && glassPipe.interact("Use") && !Inventory.isItemSelected() && !Production.isOpen()){
            ...
            Time.sleepUntil(Inventory::isItemSelected, 1250);
        ...
        }else if (Inventory.isItemSelected() && moltenGlass != null && moltenGlass.interact("Use") && !Production.isOpen()){
                ...
                Time.sleepUntil(Production::isOpen, 3000);
                    ...
                    Production.initiate(UserInterfaceData.itemToBlowIndex);
